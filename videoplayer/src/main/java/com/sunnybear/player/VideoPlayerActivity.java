 ...
 */
public class VideoPlayerActivity extends Activity implements View.OnClickListener, SurfaceHolder.Callback, ExoPlayer.Listener, MediaCodecVideoTrackRenderer.EventListener {
    public final static String VIDEO_URL = "__VIDEO_URL__";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (url == null || url.length() == 0) {
            showMessage(this, "video url is null!!!");
            return;
        }
        //初始化surface
    ...
    private void buildRenders() {
        FrameworkSampleSource sampleSource = new FrameworkSampleSource(this, Uri.parse(url), null, 2);
        videoRenderer = new MediaCodecVideoTrackRenderer(sampleSource,
                MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT,
                0, new Handler(getMainLooper()), this, 50);
    ...
    public void onPlayerError(ExoPlaybackException e) {
        ...
        showMessage(this, "发生错误, 请检验网络或者文件是否可用. error:" + e.getMessage());
        showReplay();
    }
    ...
    public void onDecoderInitializationError(MediaCodecTrackRenderer.DecoderInitializationException e) {
        ...
        showMessage(this, "decoder initialization error " + e.getMessage());
        showReplay();
    }
    ...
    public void onCryptoError(MediaCodec.CryptoException e) {
        ...
        showMessage(this, "onCryptoError " + e.getMessage());
        showReplay();
    }
